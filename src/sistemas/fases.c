...
/* ============================================================================
 * FASE 2 — P \/ Q  (OR)
 * Dois botoes em plataformas separadas. Qualquer um ja abre a porta.
 * ========================================================================== */
 ...
 * Enganosa: ativar P fecha a porta! Deixar P=F e ativar Q=V.
 * ========================================================================== */
static void carregar_fase3(Fase *f) {
    ...
    f->qtd_botoes = 2;
    /* Botao P — armadilha: ativar impede a abertura */
